...
def data_prep(infile):
	...
	for column_name in df.columns:
		...
		new_dataframes['df0'+str(i)]['SF'] = column_name.split('_')[0].strip()
		new_dataframes['df0'+str(i)]['PDBbind Version'] = column_name.split('_')[-1].strip()
...
def myplot():
	...
	p = sns.catplot(x="SF", y="AUROC", kind="box", hue='PDBbind Version',
					height=4, aspect=2,
					#sharex=True,
					palette="Set1",
	...
	#plt.show()
	plt.savefig('boxplot_glide_SP_auroc_version.png', format='png', bbox_inches='tight', transparent=True, dpi=600)
