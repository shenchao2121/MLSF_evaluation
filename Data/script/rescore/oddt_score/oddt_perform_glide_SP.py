...
def oddt_perform(pdbname, ligname, label, i, return_dict):
    ...
    for n in range(1, 4):
        ...
        lines2007 = open('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2007_out.sdf' % (
        ...
        lines2012 = open('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2012_out.sdf' % (
        pdbname, pdbname, label, ligname, ligname, n)).readlines()
        nnscore_2012 = None
        rfscorev1_2012 = None
        rfscorev2_2012 = None
        ...
        lines2013 = open('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2013_out.sdf' % (
        pdbname, pdbname, label, ligname, ligname, n)).readlines()
        nnscore_2013 = None
        rfscorev1_2013 = None
        rfscorev2_2013 = None
        ...
        lines2014 = open('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2014_out.sdf' % (
        pdbname, pdbname, label, ligname, ligname, n)).readlines()
        nnscore_2014 = None
        rfscorev1_2014 = None
        rfscorev2_2014 = None
        ...
        lines2015 = open('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2015_out.sdf' % (
        pdbname, pdbname, label, ligname, ligname, n)).readlines()
        nnscore_2015 = None
        rfscorev1_2015 = None
        rfscorev2_2015 = None
        ...
        lines2016 = open('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2016_out.sdf' % (
        pdbname, pdbname, label, ligname, ligname, n)).readlines()
        nnscore_2016 = None
        rfscorev1_2016 = None
        rfscorev2_2016 = None
        ...
        os.remove('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2007_out.sdf' % (pdbname, pdbname, label, ligname, ligname, n))
        os.remove('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2012_out.sdf' % (pdbname, pdbname, label, ligname, ligname, n))
        os.remove('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2013_out.sdf' % (pdbname, pdbname, label, ligname, ligname, n))
        os.remove('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2014_out.sdf' % (pdbname, pdbname, label, ligname, ligname, n))
        os.remove('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2015_out.sdf' % (pdbname, pdbname, label, ligname, ligname, n))
        os.remove('%s/%s_%s_glide_SP/%s/%s_top%s_oddt2016_out.sdf' % (pdbname, pdbname, label, ligname, ligname, n))
...
def interagte_result(pdbname, label):
    ...
    pool.close()
    pool.join()
    mycsv = open('%s/%s_%s_glide_SP/%s_%s_glide_SP_oddt_score.csv' % (pdbname, pdbname, label, pdbname, label),
                 'w')
